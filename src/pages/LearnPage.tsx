  ...
  const missionTimeline = [
    {
      ...
      content: (
        <div>
          <h3 className="text-2xl font-bold text-white mb-4">🎯 Production-First Learning</h3>
          <p className="text-gray-300 text-base md:text-lg mb-6 leading-relaxed">
            Every lesson is built from real production scenarios, ensuring you learn skills that
            matter in the field. No theoretical fluff—just practical, battle-tested knowledge.
          </p>
          <div className="grid grid-cols-2 gap-4">
            <img
              src="https://images.unsplash.com/photo-1667372393119-3d4c48d07fc9?w=500&h=300&fit=crop"
              alt="Kubernetes"
              className="rounded-lg object-cover h-32 md:h-48 w-full shadow-xl"
            />
            <img
              src="https://images.unsplash.com/photo-1605745341112-85968b19335b?w=500&h=300&fit=crop"
              alt="Docker"
              className="rounded-lg object-cover h-32 md:h-48 w-full shadow-xl"
            />
          </div>
    ...
    },
    {
      ...
      content: (
        <div>
          <h3 className="text-2xl font-bold text-white mb-4">🛠️ Hands-On Experience</h3>
          <p className="text-gray-300 text-base md:text-lg mb-6 leading-relaxed">
            Work with actual infrastructure, not simulations. Break things, fix them, and learn from
            real consequences. Build muscle memory through repetition.
          </p>
          <div className="grid grid-cols-2 gap-4">
            <img
    ...
    },
    {
      ...
      content: (
        <div>
          <h3 className="text-2xl font-bold text-white mb-4">👥 Industry Mentorship</h3>
          <p className="text-gray-300 text-base md:text-lg mb-6 leading-relaxed">
            Learn from engineers who've scaled systems at companies like Netflix, Google, and
            Amazon. Get insider knowledge and career guidance.
          </p>
    ...
    },
    {
      ...
      content: (
        <div>
          ...
          <p className="text-gray-300 text-base md:text-lg mb-6 leading-relaxed">
            Graduate with a portfolio of production-ready projects and direct connections to hiring
            partners. Land your dream DevOps role.
          </p>
          <div className="grid grid-cols-2 gap-4">
            <img
  ...
  return (
    <GeometricPageWrapper>
      <div className="min-h-screen text-white">
        ...
        {/* Programs Section */}
        <section id="programs" className="py-20 bg-black/20 backdrop-blur-sm">
          <div className="max-w-7xl mx-auto px-6">
            <div className="text-center mb-16">
              <h2 className="text-4xl md:text-5xl font-bold mb-6">
                Programs Built in{" "}
        ...
        {/* Team Section */}
        <section id="team" className="py-20 bg-gray-900/30 backdrop-blur-sm">
          <div className="max-w-7xl mx-auto px-6">
            <div className="text-center mb-16">
              <h2 className="text-4xl md:text-5xl font-bold mb-6">
                Meet the{" "}
        ...
        {/* Footer */}
        <footer className="bg-black/40 backdrop-blur-sm py-16 border-t border-white/5">
          <div className="max-w-7xl mx-auto px-6">
